  ...
  const projects = [
    {
      ...
      description:
        "An Android app for emergency health assistance. Features include creating and updating patient medical history, an emergency SOS button to send data and location to family members and nearest ambulance services, and medical reminders.",
    ...
    },
    {
      ...
      description:
        "An Android app for farmers. Features include daily weather updates, APMC prices display, and an e-commerce marketplace for farmers to upload and buy products.",
    ...
    },
    {
      ...
      description:
        "An Android app to track cryptocurrency prices in real-time.",
    ...
    },
    {
      ...
      description:
        "A website for custom phone case covers and laptop skins. Users can design and order personalized cases and skins.",
    ...
    },
    {
      ...
      description:
        "A computer vision project using OpenCV for real-time sign language detection.",
